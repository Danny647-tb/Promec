...
<head>
    <meta charset="utf-8">
    <title>Promec.Jr S.A.S | Cotización</title>
...
<body>
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="facturacion.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Facturaciòn</a>
    ...
    <div class="container">
        ...
        <img src="img/Logo2.png" alt="Logo" class="logo">
            <h1>PROMEC JR SAS | COTIZACIÒN</h1>
        ...
        <div class="info">
            <div class="left">
                <div><strong>Cotización Electrónica No.:</strong> <input type="text" id="quoteNumber" value="PM 313"></div>
                <div><strong>Fecha y hora de Cotización:</strong> <input type="datetime-local" id="quoteDate" value="2024-08-08T15:59"></div>
                <div><strong>Validez de la Cotización:</strong> <input type="datetime-local" id="validityDate" value="2024-08-09T15:59"></div>
            </div>
            <div class="right">
        ...
        <div class="info">
            <div class="left">
                ...
                <br>
                <p class="fixed-info">CONDICIONES DE COTIZACIÒN <br>
            ...
            <table id="quoteTable">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" class="itemDescription" value="Solicitud de Cotización - Tratado de puertas de madera para mantenimiento y pintura"></td>
