    ...
    if (filter_var($correo, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            try {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'gaesdanny@gmail.com';
                $mail->Password = 'frxh eeju mlpk kugt'; // Usa contraseñas de aplicación si es necesario
                $mail->SMTPSecure = 'tls';
                $mail->Port = 587;

                // Destinatario
                $mail->setFrom('gaesdanny@gmail.com', 'PROMEC');
                    ...
                    <body>
                        ...
                        <script>
                            Swal.fire({
                                ...
                                window.location = '../changePassword.php'; // Redirige después de cerrar el Swal
                            });
                        </script>
                    </body>
                    </html>";
                    ...
                    <body>
                        ...
                        <script>
                            Swal.fire({
                                ...
                                window.location = '../signin.php'; // Redirige después de cerrar el Swal
                            });
                        </script>
                    </body>
                    </html>";
